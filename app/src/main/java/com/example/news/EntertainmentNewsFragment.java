...
public class EntertainmentNewsFragment extends Fragment {
    ...
    /**
     * @param entertainmentNewsURL    - Url to the Entertainment category news.
     */
    String entertainmentNewsURL;

    /**
     * @param entertainmentNewsList   - List of Entertainment News.
     */

    List<News> entertainmentNewsList = new ArrayList<>();

    public EntertainmentNewsFragment(String entertainmentNewsURL) {
        this.entertainmentNewsURL = entertainmentNewsURL;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(Request.Method.GET,
            ...
            try {
                ...
                for(int i = 0; i < item.length(); i++) {
                    ...
                    entertainmentNewsList.add(new News(urlToImage, urlToNews, news_title, news_name, news_time));
                }
        ...
        recyclerView.setAdapter(new NewsAdapter(view.getContext() ,entertainmentNewsList));
        return view;
    }
}