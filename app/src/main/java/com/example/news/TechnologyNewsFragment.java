...
public class TechnologyNewsFragment extends Fragment {
    ...
    /**
     * @param technologyNewsURL    - Url to the Technology category news.
     */
    String technologyNewsURL;

    /**
     * @param technologyNewsList   - List of Technology News.
     */

    List<News> technologyNewsList = new ArrayList<>();

    public TechnologyNewsFragment(String technologyNewsURL) {
        this.technologyNewsURL = technologyNewsURL;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(Request.Method.GET,
            ...
            try {
                ...
                for(int i = 0; i < item.length(); i++) {
                    ...
                    technologyNewsList.add(new News(urlToImage, urlToNews, news_title, news_name, news_time));
                }
        ...
        recyclerView.setAdapter(new NewsAdapter(view.getContext() ,technologyNewsList));
        return view;
    }
}