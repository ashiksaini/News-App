...
public class ScienceNewsFragment extends Fragment {
    ...
    /**
     * @param scienceNewsURL    - Url to the Science category news.
     */
    String scienceNewsURL;

    /**
     * @param scienceNewsList   - List of Science News.
     */

    List<News> scienceNewsList = new ArrayList<>();

    public ScienceNewsFragment(String scienceNewsURL) {
        this.scienceNewsURL = scienceNewsURL;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(Request.Method.GET,
            ...
            try {
                ...
                for(int i = 0; i < item.length(); i++) {
                    ...
                    scienceNewsList.add(new News(urlToImage, urlToNews, news_title, news_name, news_time));
                }
        ...
        recyclerView.setAdapter(new NewsAdapter(view.getContext() ,scienceNewsList));
        return view;
    }
}