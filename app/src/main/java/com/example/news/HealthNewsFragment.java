...
public class HealthNewsFragment extends Fragment {
    ...
    /**
     * @param healthNewsURL    - Url to the Health category news.
     */
    String healthNewsURL;

    /**
     * @param healthNewsList   - List of Health News.
     */

    List<News> healthNewsList = new ArrayList<>();

    public HealthNewsFragment(String healthnewsUrl) {
        this.healthNewsURL = healthnewsUrl;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(Request.Method.GET,
            ...
            try {
                ...
                for(int i = 0; i < item.length(); i++) {
                    ...
                    healthNewsList.add(new News(urlToImage, urlToNews, news_title, news_name, news_time));
                }
        ...
        recyclerView.setAdapter(new NewsAdapter(view.getContext() ,healthNewsList));
        return view;
    }
}